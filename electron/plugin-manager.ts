...
export class PluginManager {
  ...
  private constructor() {
    ...
    // User data path for storing custom scripts (writable in production)
    const userDataPath = app ? app.getPath("userData") : process.cwd();

    // For production, use user data directory to store scripts
    // This ensures scripts directory is writable in packaged app
    this.scriptsDirectory = isProduction
      ? path.join(userDataPath, "scripts")
    ...
    console.log("Scripts directory:", this.scriptsDirectory);
    console.log("Built-in scripts directory:", this.builtInScriptsDirectory);
